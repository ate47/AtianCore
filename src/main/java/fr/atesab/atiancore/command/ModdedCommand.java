...
/**
 * a command to register with {@link AtianCore#registerCommand(ModdedCommand)}
 * 
 * @author ATE47
 *
 */
public abstract class ModdedCommand {
	...
	/**
	 * create a prefix {@link ITextComponent} with a color and a border
	 * 
	 * @param text
	 *            the text in the prefix
	 * @param color
	 *            the text color
	 * @param border
	 *            the border color
	...
	/**
	 * create a text {@link ITextComponent} with a color
	 * 
	 * @param text
	 *            the text
	 * @param color
	...
	/**
	 * create a translated prefix {@link ITextComponent} with a color and a border
	 * 
	 * @param lang
	 *            the prefix lang
	 * @param color
	 ...
	 * @return the component
	 */
	public static ITextComponent createTranslatedPrefix(String lang, TextFormatting color, TextFormatting border,
			Object... args) {
		return createText("[", border).appendSibling(createTranslatedText(lang, color, args))
				.appendSibling(createText("] ", border));
	}

	/**
	 * create a translated text {@link ITextComponent} with a color
	 * 
	 * @param lang
	 *            the text lang
	 * @param color
